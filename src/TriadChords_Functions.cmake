...
# include_directories(${TriadChords_BINARY_DIR}/TriadChordsLib)
# include_directories(${TriadChordsLib_BINARY_DIR})

macro (TriadChords_SetupInstallDirs)
  set(install_dir "bin")
  ...
  if(APPLE)
    ...
    set(install_dir "${TriadChords_PACKAGE_DEST_PREFIX}/")
    set(lib_install_dir "${TriadChords_PACKAGE_DEST_PREFIX}/lib")
    set(extra_install_dir "${TriadChords_PACKAGE_DEST_PREFIX}/bin")
    set(include_install_dir "${TriadChords_PACKAGE_DEST_PREFIX}/include")
    set(top_install_dir "${TriadChords_PACKAGE_DEST_PREFIX}/")
...
function(Add_TriadChords_Executable)
  set(options )
  ...
  elseif(APPLE)
    get_property(TriadChords_PACKAGE_DEST_PREFIX GLOBAL PROPERTY TriadChords_PACKAGE_DEST_PREFIX)
    set(install_dir "${TriadChords_PACKAGE_DEST_PREFIX}/bin")
    set(lib_install_dir "${TriadChords_PACKAGE_DEST_PREFIX}/lib")
  elseif(WIN32)
    set(install_dir "bin")
    set(lib_install_dir "lib")
  ...
  BuildToolBundle(TARGET ${Z_TARGET}
                ...
                VERSION_MAJOR ${TriadChords_VER_MAJOR}
                VERSION_MINOR ${TriadChords_VER_MINOR}
                VERSION_PATCH ${TriadChords_VER_PATCH}
                BINARY_DIR ${TriadChords_BINARY_DIR}/Applications/${Z_TARGET}
  ...
  set_target_properties(${Z_TARGET} PROPERTIES BUILD_RPATH "${TriadChords_OpenMP_LIB_DIR}")
...
# #---------------------------------------------------------------------
# # This function will add a new TriadChords unit test
# function(AddTriadChordsUnitTest)
#     set(options)
...
#     set(TEST_SOURCE_FILE "${TriadChords_BINARY_DIR}/${Z_SOLUTION_FOLDER}/${Z_TEST_NAME}Test.cpp")
#     configure_file("${TriadChords_SOURCE_DIR}/Source/Test/UnitTestMain.cpp.in"
